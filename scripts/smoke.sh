...
for t in lay_contour lay_water lay_planting lay_path lay_wall read_sheet undo_gesture title_sheet clear_sheet export_sheet; do
...
grep -q 'wt&&(W!==wtW||j!==wtJ)' vendor/p5.brush.js || { echo "p5.brush field-grid patch missing"; exit 1; }
